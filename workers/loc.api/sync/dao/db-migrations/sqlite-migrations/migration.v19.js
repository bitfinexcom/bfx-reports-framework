...
class MigrationV19 extends AbstractMigration {
  ...
  up () {
    const sqlArr = [
      'DROP INDEX IF EXISTS ledgers_mts_currency',
      'DROP INDEX IF EXISTS trades_mtsCreate_symbol',
      'DROP INDEX IF EXISTS fundingTrades_mtsCreate_symbol',
      'DROP INDEX IF EXISTS publicTrades_mts__symbol',
      'DROP INDEX IF EXISTS orders_mtsUpdate_symbol',
      'DROP INDEX IF EXISTS movements_mtsUpdated_currency',
      'DROP INDEX IF EXISTS fundingOfferHistory_mtsUpdate_symbol',
      'DROP INDEX IF EXISTS fundingLoanHistory_mtsUpdate_symbol',
      'DROP INDEX IF EXISTS fundingCreditHistory_mtsUpdate_symbol',
      'DROP INDEX IF EXISTS positionsHistory_mtsUpdate_symbol',
      'DROP INDEX IF EXISTS positionsSnapshot_mtsUpdate_symbol',
      'DROP INDEX IF EXISTS logins_time',
      'DROP INDEX IF EXISTS changeLogs_mtsCreate',
      'DROP INDEX IF EXISTS tickersHistory_mtsUpdate_symbol',
  ...
  down () {
    const sqlArr = [
      'DROP INDEX IF EXISTS ledgers_user_id_wallet_currency_mts',
      'DROP INDEX IF EXISTS ledgers_user_id_wallet_mts',
      'DROP INDEX IF EXISTS ledgers_user_id_currency_mts',
      'DROP INDEX IF EXISTS ledgers_user_id__isMarginFundingPayment_mts',
      'DROP INDEX IF EXISTS ledgers_user_id__isAffiliateRebate_mts',
      'DROP INDEX IF EXISTS ledgers_user_id__isStakingPayments_mts',
      'DROP INDEX IF EXISTS ledgers_user_id__category_mts',
      'DROP INDEX IF EXISTS ledgers_user_id_mts',
      'DROP INDEX IF EXISTS ledgers_currency_mts',
      'DROP INDEX IF EXISTS ledgers_user_id_subUserId_mts',
      'DROP INDEX IF EXISTS ledgers_subUserId_mts__id',

      'DROP INDEX IF EXISTS trades_user_id_symbol_mtsCreate',
      'DROP INDEX IF EXISTS trades_user_id_orderID_mtsCreate',
      'DROP INDEX IF EXISTS trades_user_id_mtsCreate',
      'DROP INDEX IF EXISTS trades_user_id_subUserId_mtsCreate',
      'DROP INDEX IF EXISTS trades_subUserId_orderID',

      'DROP INDEX IF EXISTS fundingTrades_user_id_symbol_mtsCreate',
      'DROP INDEX IF EXISTS fundingTrades_user_id_mtsCreate',
      'DROP INDEX IF EXISTS fundingTrades_user_id_subUserId_mtsCreate',

      'DROP INDEX IF EXISTS publicTrades__symbol_mts',
      'DROP INDEX IF EXISTS publicTrades_mts',

      'DROP INDEX IF EXISTS orders_user_id_symbol_mtsUpdate',
      'DROP INDEX IF EXISTS orders_user_id_type_mtsUpdate',
      'DROP INDEX IF EXISTS orders_user_id_mtsUpdate',
      'DROP INDEX IF EXISTS orders_user_id_subUserId_mtsUpdate',

      'DROP INDEX IF EXISTS movements_user_id_status_mtsStarted',
      'DROP INDEX IF EXISTS movements_user_id_status_mtsUpdated',
      'DROP INDEX IF EXISTS movements_user_id_currency_mtsUpdated',
      'DROP INDEX IF EXISTS movements_user_id_mtsUpdated',
      'DROP INDEX IF EXISTS movements_user_id_subUserId_mtsUpdated',

      'DROP INDEX IF EXISTS fundingOfferHistory_user_id_symbol_mtsUpdate',
      'DROP INDEX IF EXISTS fundingOfferHistory_user_id_status_mtsUpdate',
      'DROP INDEX IF EXISTS fundingOfferHistory_user_id_mtsUpdate',
      'DROP INDEX IF EXISTS fundingOfferHistory_user_id_subUserId_mtsUpdate',

      'DROP INDEX IF EXISTS fundingLoanHistory_user_id_symbol_mtsUpdate',
      'DROP INDEX IF EXISTS fundingLoanHistory_user_id_status_mtsUpdate',
      'DROP INDEX IF EXISTS fundingLoanHistory_user_id_mtsUpdate',
      'DROP INDEX IF EXISTS fundingLoanHistory_user_id_subUserId_mtsUpdate',

      'DROP INDEX IF EXISTS fundingCreditHistory_user_id_symbol_mtsUpdate',
      'DROP INDEX IF EXISTS fundingCreditHistory_user_id_status_mtsUpdate',
      'DROP INDEX IF EXISTS fundingCreditHistory_user_id_mtsUpdate',
      'DROP INDEX IF EXISTS fundingCreditHistory_user_id_subUserId_mtsUpdate',

      'DROP INDEX IF EXISTS positionsHistory_user_id_symbol_mtsUpdate',
      'DROP INDEX IF EXISTS positionsHistory_user_id_mtsUpdate_mtsCreate',
      'DROP INDEX IF EXISTS positionsHistory_user_id_mtsUpdate',
      'DROP INDEX IF EXISTS positionsHistory_user_id_subUserId_mtsUpdate',
      'DROP INDEX IF EXISTS positionsHistory_subUserId_id',

      'DROP INDEX IF EXISTS positionsSnapshot_user_id_mtsUpdate',
      'DROP INDEX IF EXISTS positionsSnapshot_user_id_symbol_mtsUpdate',
      'DROP INDEX IF EXISTS positionsSnapshot_user_id_subUserId_mtsUpdate',

      'DROP INDEX IF EXISTS logins_user_id_time',
      'DROP INDEX IF EXISTS logins_user_id_subUserId_time',

      'DROP INDEX IF EXISTS changeLogs_user_id_mtsCreate',
      'DROP INDEX IF EXISTS changeLogs_user_id_subUserId_mtsCreate',

      'DROP INDEX IF EXISTS tickersHistory_symbol_mtsUpdate',

      'DROP INDEX IF EXISTS statusMessages_key_timestamp',

      'DROP INDEX IF EXISTS candles__timeframe__symbol_mts',
      'DROP INDEX IF EXISTS candles__timeframe_mts',
      'DROP INDEX IF EXISTS candles__symbol_mts',
      'DROP INDEX IF EXISTS candles_close_mts',
